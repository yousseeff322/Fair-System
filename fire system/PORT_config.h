...
/* choose 0 for input  OR  1 for output */
  ...
  #define PORTD_PIN7_DIR   0
	...
	*/ 
	...
	#define PORTB_PIN1_INT   1
	#define PORTB_PIN2_INT   0
	#define PORTB_PIN3_INT   0
	#define PORTB_PIN4_INT   1
	#define PORTB_PIN5_INT   1
	#define PORTB_PIN6_INT   1
	#define PORTB_PIN7_INT   1
	
	#define PORTC_PIN0_INT   1
	#define PORTC_PIN1_INT   1
	#define PORTC_PIN2_INT   1
	#define PORTC_PIN3_INT   0
	#define PORTC_PIN4_INT   0
	#define PORTC_PIN5_INT   1
