...
#define KEY_COULMES    DIO_u8PORTD
#define KEY_ROWS   	   DIO_u8PORTB

#define KEYPAD_COLUME0_PIN  DIO_u8PIN2
#define KEYPAD_COLUME1_PIN  DIO_u8PIN3
#define KEYPAD_COLUME2_PIN  DIO_u8PIN4
#define KEYPAD_COLUME3_PIN  DIO_u8PIN5
